...
WHERE c.delivererid = d.delivererid AND
      ...
      c.numcollections >=2 AND c.numdeliveries>=1
GROUP BY  c.delivererid, c.companyid;

/* 8 */
SELECT distinct d.delivererid
FROM deliverers d,companydel c, companies cc
WHERE d.delivererid = c.delivererid AND
      c.companyid = cc.companyid AND
