<html>
  ...
  <?php
    ...
    /* CONTROLLO PARAMETRI */
    if( !isset($_REQUEST["anno1"]) or !isset($_REQUEST["anno2"]) or !isset($_REQUEST["citta"])){
      die("Errore: inserire tutti i dati richiesti");
    }
  if( !is_numeric($_REQUEST["anno1"]) or !is_numeric($_REQUEST["anno2"]) or ($_REQUEST["anno1"] > $_REQUEST["anno2"])){
